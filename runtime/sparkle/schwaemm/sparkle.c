...
void schwaemm_sparkle(uint32_t *state, int brans, int steps)
{
...
void schwaemm_sparkle_inv(uint32_t *state, int brans, int steps)
{
  int i, j;  // Step and branch counter
...
void schwaemm_clear_state(uint32_t *state, int brans)
{
  int i;
...
void schwaemm_print_state(const uint32_t *state, int brans)
{
...
void schwaemm_test_sparkle(int brans, int steps)
{
  uint32_t state[2*MAX_BRANCHES] = { 0 };
  
  printf("input:\n");
  schwaemm_print_state(state, brans);
  schwaemm_sparkle(state, brans, steps);
  printf("sparkle:\n");
  schwaemm_print_state(state, brans);
  schwaemm_sparkle_inv(state, brans, steps);
  printf("sparkle inv:\n");
  schwaemm_print_state(state, brans);
  printf("\n");
}
